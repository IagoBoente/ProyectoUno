...
"background-color: qlineargradient(spread:pad, x1:0.483, y1:0, x2:0.506, y2:0.625, stop:0 rgba(170, 255, 255, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.line_2.setGeometry(QtCore.QRect(40, 240, 761, 16))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.lblNome = QtWidgets.QLabel(self.centralwidget)
        self.lblNome.setGeometry(QtCore.QRect(410, 160, 47, 13))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.editNome.setGeometry(QtCore.QRect(470, 160, 211, 21))
        self.editNome.setObjectName("editNome")
        self.btnAceptar = QtWidgets.QPushButton(self.centralwidget)
        self.btnAceptar.setGeometry(QtCore.QRect(320, 270, 75, 23))
        self.btnAceptar.setObjectName("btnAceptar")
        self.btnSalir = QtWidgets.QPushButton(self.centralwidget)
        self.btnSalir.setGeometry(QtCore.QRect(450, 270, 75, 23))
        self.btnSalir.setObjectName("btnSalir")
        self.lblSexo = QtWidgets.QLabel(self.centralwidget)
        self.lblSexo.setGeometry(QtCore.QRect(60, 210, 47, 13))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
